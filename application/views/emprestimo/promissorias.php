        ...
        <div class="imprimir">
            ...
            <div class="titulo">
                ...
                <div class="nota" style="text-align: right;">
                    <p>Nº <b>#<?= $emprestimo['ID_Filho'];?>/<?= date('Y');?>#</b></p>
                </div>
                ...
                <div>
                    <p>No dia <b class="wordup">
                        ...
                        <?= date('d',strtotime($emprestimo['Data_Pagamento']?:$emprestimo['Data_Previsao']));?></b>

                         de <b class="wordup"><?= nomeMes(date('m',strtotime($emprestimo['Data_Pagamento']?:$emprestimo['Data_Previsao']))); ?></b> 
                         de <b class="ano"> <?= date('Y', strtotime($emprestimo['Data_Pagamento']?:$emprestimo['Data_Previsao']));?> </b>
