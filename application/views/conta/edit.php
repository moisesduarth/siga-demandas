    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Conta (Editar)</h3>
            </div>
			<?php echo form_open('conta/edit/'.$conta['ID_Conta']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="Status_Conta" class="form-control">
								...
								{
									$selected = ($value == $conta['Status_Conta']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Descricao_Conta" value="<?php echo ($this->input->post('Descricao_Conta') ? $this->input->post('Descricao_Conta') : $conta['Descricao_Conta']); ?>" class="form-control" id="Descricao_Conta" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Saldo_Conta" value="<?php echo ($this->input->post('Saldo_Conta') ? $this->input->post('Saldo_Conta') : $conta['Saldo_Conta']); ?>" class="form-control" id="Saldo_Conta" />
