<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('observacao_emprestimo/edit/'.$observacao_emprestimo['ID_Observacao_Emprestimo']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ID_Parcela" class="form-control">
								...
								{
									$selected = ($renegociacao_parcela['ID_Renegociacao_Parcela'] == $observacao_emprestimo['ID_Parcela']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Observacao_Emprestimo" value="<?php echo ($this->input->post('Observacao_Emprestimo') ? $this->input->post('Observacao_Emprestimo') : $observacao_emprestimo['Observacao_Emprestimo']); ?>" class="form-control" id="Observacao_Emprestimo" />
