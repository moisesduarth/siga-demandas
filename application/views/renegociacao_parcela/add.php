    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Renegociacao Parcela</h3>
            </div>
            <?php echo form_open('renegociacao_parcela/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ID_Renegociacao" class="form-control">
								...
								{
									$selected = ($renegociacao['ID_Renegociacao'] == $this->input->post('ID_Renegociacao')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="Status_Parcela" class="form-control">
								...
								{
									$selected = ($value == $this->input->post('Status_Parcela')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						<label for="Data_Prazo_Parcela" class="control-label"><span class="text-danger">*</span>Vencimento Parcela</label>
						<div class="form-group">
