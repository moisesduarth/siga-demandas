    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Pagamento (Editar)</h3>
            </div>
			...
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="ID_Emprestimo" class="form-control">
								...
								{
									$selected = ($emprestimo['ID_Emprestimo'] == $pagamento['ID_Emprestimo']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Data_Pagamento" value="<?php echo ($this->input->post('Data_Pagamento') ? $this->input->post('Data_Pagamento') : formataData($pagamento['Data_Pagamento'])); ?>" class="has-datetimepicker form-control" id="Data_Pagamento" />
