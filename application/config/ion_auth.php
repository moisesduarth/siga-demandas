...
$config['default_group']              = 'cobrador';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['operador_group']             = 'operador';             // Default administrators group, use name
$config['cobrador_group']             = 'cobrador';             // Default administrators group, use name
