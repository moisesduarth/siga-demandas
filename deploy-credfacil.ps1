...
$client.UploadFile("ftp://sistemasaf.com.br/public_html/credfacil/deploy.php", "C:\xampp\htdocs\emprestimo\deploy.php")
$client.UploadFile("ftp://sistemasaf.com.br/public_html/credfacil/emprestimo.zip", "C:\xampp\htdocs\emprestimo.zip")

Invoke-WebRequest http://sistemasaf.com.br/credfacil/deploy.php -OutFile log-deploy.txt
